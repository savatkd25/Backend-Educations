...
Route::get('/materias', [MateriaController::class, 'index']) -> middleware('CheckRole');
...
Route::get('/usuarios/docentes', [UsuarioController::class, 'getDocentes']);
Route::get('/usuarios/estudiantes', [UsuarioController::class, 'getEstudiantes']);
